...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\ROY\projects\football_project\MyZipCode_Passion_Project\ionic-fb\src\pages\home\home.html"*/'<!--\n\n  Generated template for the HomePage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>Home</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <button ion-button block (click)="findLeague()">Find A League</button>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\ROY\projects\football_project\MyZipCode_Passion_Project\ionic-fb\src\pages\home\home.html"*/,
        }),
...
var TeamsPage = /** @class */ (function () {
    ...
    TeamsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-teams',template:/*ion-inline-start:"C:\Users\ROY\projects\football_project\MyZipCode_Passion_Project\ionic-fb\src\pages\teams\teams.html"*/'<ion-header>\n\n\n\n  <ion-navbar color="primary">\n\n    <ion-title>{{league.name}} Teams</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content>\n\n    <button *ngFor="let team of teams" ion-item (click)="itemTapped($event, team)">{{team.name}}</button>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\ROY\projects\football_project\MyZipCode_Passion_Project\ionic-fb\src\pages\teams\teams.html"*/,
        }),
...
var TeamDetailsPage = /** @class */ (function () {
    ...
    TeamDetailsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-team-details',template:/*ion-inline-start:"C:\Users\ROY\projects\football_project\MyZipCode_Passion_Project\ionic-fb\src\pages\team-details\team-details.html"*/'<ion-header>\n\n\n\n  <ion-navbar color="primary">\n\n    <ion-title>{{team.name}}</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <h2 text-center>Team Detail</h2>\n\n  <h5>Name: {{team.name}}</h5>\n\n  <p>\n\n    ShortName: {{team.shortName}}<br><br>\n\n    tla: {{team.tla}}<br><br>\n\n    Address: {{team.address}}<br><br>\n\n    Phone: {{team.phone}}<br><br>\n\n    Website: {{team.website}}<br><br>\n\n    Email: {{team.email}}<br><br>\n\n    Founded: {{team.founded}}<br><br>\n\n    ClubColors: {{team.clubColors}}<br><br>\n\n    LastUpdated: {{team.lastUpdated}}<br><br>\n\n  </p>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\ROY\projects\football_project\MyZipCode_Passion_Project\ionic-fb\src\pages\team-details\team-details.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_league_service_league_service__["a" /* LeagueServiceProvider */]])
    ], TeamDetailsPage);
...
var TeamSchedulePage = /** @class */ (function () {
    ...
    TeamSchedulePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-team-schedule',template:/*ion-inline-start:"C:\Users\ROY\projects\football_project\MyZipCode_Passion_Project\ionic-fb\src\pages\team-schedule\team-schedule.html"*/'<!--\n\n  Generated template for the TeamSchedulePage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>teamSchedule</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n    <h2>Fixture Page</h2>\n\n    <h5>Name: {{team.name}}</h5>\n\n    <div style="text-align:center" *ngFor="let match of matches">\n\n      <span (click)="goToThisHome($event, match.homeTeam)" [class.highlight]="team.name === match.homeTeam.name">{{match.homeTeam.name}}</span> \n\n      vs \n\n      <span  (click)="goToThisHome($event, match.awayTeam)"[class.highlight]="team.name === match.awayTeam.name">{{match.awayTeam.name}}</span>\n\n\n\n      <p>Half-Time Score: <span [class.bold]="team.name === match.homeTeam.name">{{match.score.halfTime.homeTeam}}</span> : <span [class.bold]="team.name === match.awayTeam.name">{{match.score.halfTime.awayTeam}}</span></p>\n\n\n\n      <p>Full-Time Score: <span [class.bold]="team.name === match.homeTeam.name">{{match.score.fullTime.homeTeam}}</span> : <span [class.bold]="team.name === match.awayTeam.name">{{match.score.fullTime.awayTeam}}</span>\n\n      </p>\n\n\n\n    </div>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\ROY\projects\football_project\MyZipCode_Passion_Project\ionic-fb\src\pages\team-schedule\team-schedule.html"*/,
        }),
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\ROY\projects\football_project\MyZipCode_Passion_Project\ionic-fb\src\app\app.html"*/'<ion-menu [content]="content">\n\n  <ion-header>\n\n    <ion-toolbar>\n\n      <ion-title>Menu</ion-title>\n\n    </ion-toolbar>\n\n  </ion-header>\n\n\n\n  <ion-content>\n\n    <ion-list>\n\n      <ion-list>\n\n        <ion-list-header>NAvigate</ion-list-header>\n\n        <button menuClose ion-item (click)="goHome()">go home</button> \n\n        <button menuClose ion-item (click)="goToTournaments()">go to tournamets</button>\n\n      </ion-list>\n\n    </ion-list>\n\n  </ion-content>\n\n\n\n</ion-menu>\n\n\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"C:\Users\ROY\projects\football_project\MyZipCode_Passion_Project\ionic-fb\src\app\app.html"*/
        }),
...
var TournamentsPage = /** @class */ (function () {
    ...
    TournamentsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-tournaments',template:/*ion-inline-start:"C:\Users\ROY\projects\football_project\MyZipCode_Passion_Project\ionic-fb\src\pages\tournaments\tournaments.html"*/'\n\n<ion-header>\n\n\n\n  <ion-navbar color="primary">\n\n    <ion-title>Tournaments</ion-title>\n\n  </ion-navbar>\n\n  <ion-toolbar color="secondary">\n\n    <ion-title text-center><span>Select A league Below</span></ion-title>\n\n  </ion-toolbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content color ="secondary">\n\n    <!-- <button ion-item (click)="getToteamsPage($event, league)">test</button> -->\n\n    <button  class="test" *ngFor="let league of leagues" ion-item (click)="goToTeamsPage($event, league)">{{league.name}}</button>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\ROY\projects\football_project\MyZipCode_Passion_Project\ionic-fb\src\pages\tournaments\tournaments.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
